...
function Services(){
    return(
       <section p-10>
        <div className="grid grid-cols-2 px-10 bg-blue-200">
   <h1 className="text-6xl p-10 font-semibold"> &nbsp;&nbsp; &nbsp; &nbsp;We re a digital
marketing agency
with expertise</h1>
        </div>
...
<div className="m-10  pb-10 border-b-2 border-gray-80">
            <p className="text-[22vw] font-semibold">Design</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-col-2 lg:grid-cols-2">
<div>
    <div className="px-5 ">
    <h1 className="text-[5vw] md:text-[3.5vw] lg:text-[3vw] tracking-tight  font-semibold">Brand designers and web designers in-house crafting visuals to match your brand values.</h1>
    </div>
</div>
<div className="p-5 items-center">
    <div className=" p-4 hover:border-b-2 hover:border-gray-300 items-center hover:translate-x-5 duration-200 ">
...
<div className="pb-10 m-10 border-b-2 border-gray-80">
            <p className="text-[22vw] font-semibold">Develop</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-col-2 lg:grid-cols-2">
<div>
    <div className="px-5 ">
    <h1 className="text-[5vw] md:text-[3.5vw] lg:text-[3vw]  tracking-tight  font-semibold">Web development to the highest standards, and matching the latest industry requirements.</h1>
    </div>
</div>
<div className="p-5 items-center">
    <div className=" p-4 hover:border-b-2 hover:border-gray-300 items-center hover:translate-x-5 duration-200 ">
...
<div className="pb-10  m-10 border-b-2 border-gray-80">
            <p className="text-[22vw] font-semibold">Support</p>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-col-2 lg:grid-cols-2">
<div>
    <div className="px-5 ">
    <h1 className="text-[5vw] md:text-[3.5vw] lg:text-[3vw]  tracking-tight  font-semibold">Lean on our in-house team to support with your design, development and seo needs.</h1>
    </div>
</div>
<div className="p-5 items-center">
    <div className=" p-4 hover:border-b-2 hover:border-gray-300 items-center hover:translate-x-5 duration-200 ">
